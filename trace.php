<!DOCTYPE html>
</html><html lang="en" style="height: auto;"><head>
  <meta charset="utf-8">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark ">
    ...
    <ul class="navbar-nav">
        ...
        <a class="nav-link" data-widget="pushmenu" href="" role="button"><i class="fas fa-bars"></i></a>
          ...
          <li>
        <a class="nav-link text-white" href="./" role="button"> <large><b>Air Cargo Management System</b></large></a>
      </li>
    </ul>
  ...
  <script>
    ...
    <div class="sidebar pb-4 mb-4 os-host os-theme-light os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-scrollbar-vertical-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px -8px -24px; width: 249px; height: 615px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible"><div class="os-content" style="padding: 0px 8px 24px; height: 100%; width: 100%;">
      <nav class="mt-2">
              ...
              <li class="nav-item">
                <a href="./index.php?page=parcel_list" class="nav-link nav-parcel_list nav-sall tree-item">
                  ...
                  <p>List All</p>
                            ...
                            <li class="nav-item">
                <a href="./index.php?page=parcel_list&amp;s=0" class="nav-link nav-parcel_list_0 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Item Accepted<br>by Courier</p>
                </a>
              </li>
                          <li class="nav-item">
                <a href="./index.php?page=parcel_list&amp;s=1" class="nav-link nav-parcel_list_1 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Collected</p>
                </a>
              </li>
                          <li class="nav-item">
                <a href="./index.php?page=parcel_list&amp;s=2" class="nav-link nav-parcel_list_2 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Shipped</p>
                </a>
              </li>
                          <li class="nav-item">
                <a href="./index.php?page=parcel_list&amp;s=3" class="nav-link nav-parcel_list_3 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>In-Transit</p>
                </a>
              </li>
                          <li class="nav-item">
                <a href="./index.php?page=parcel_list&amp;s=4" class="nav-link nav-parcel_list_4 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Arrived At<br>Destination</p>
                </a>
              </li>
                          <li class="nav-item">
                <a href="./index.php?page=parcel_list&amp;s=5" class="nav-link nav-parcel_list_5 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Out for Delivery</p>
                </a>
              </li>
                          <li class="nav-item">
                <a href="./index.php?page=parcel_list&amp;s=6" class="nav-link nav-parcel_list_6 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Ready to Pickup</p>
                </a>
              </li>
                          <li class="nav-item">
                <a href="./index.php?page=parcel_list&amp;s=7" class="nav-link nav-parcel_list_7 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Delivered</p>
                </a>
              </li>
                          <li class="nav-item">
                <a href="./index.php?page=parcel_list&amp;s=8" class="nav-link nav-parcel_list_8 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Picked-up</p>
                </a>
              </li>
                ...
                <a href="./index.php?page=parcel_list&amp;s=9" class="nav-link nav-parcel_list_9 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Unsuccessfull<br>Delivery Attempt</p>
                </a>
              </li>
                        </ul>
          </li>
