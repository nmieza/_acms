  ...
  <div class="row content">
    ...
    <br>
      ...
      <ul class="nav nav-pills nav-stacked">
        <li><a href="http://aircargo.test/">Dashboard</a></li>
        <li class="active"><a href="http://aircargo.test/addNewShipment.php">Add New Shipment</a></li>
        <li><a href="http://aircargo.test/shipmentList.php">Shipment List</a></li>
        <li><a href="http://aircargo.test/cargoType.php">Cargo Type</a></li>
